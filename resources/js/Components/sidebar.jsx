    ...
    return (
        <>
            ...
            <div className="text-center fixed top-3 left-3 z-40">
                ...
                >
                    <svg
                        className={`w-6 h-6 text-gray-800 dark:text-white ${isOpen ? 'rotate-90' : ''}`}
                        aria-hidden="true"
            ...
            <div
                ...
                className={`fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} bg-white dark:bg-gray-800`}
                tabIndex="-1"
                    ...
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <a href="/gallery" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Galeri Foto</span>
                                <span className="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700"></span>
                            </a>
                        </li>
                        <li>
                            <a href="/album" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Album Foto</span>
                                <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 "></span>
                            </a>
                        </li>
                        <li>
                            <a href="/favorit" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Favorit</span>
                            </a>
                        </li>
                    </ul>
                </div>
